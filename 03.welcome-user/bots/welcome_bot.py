...
from data_models import WelcomeState
...
class WelcomeBot(ActivityHandler):
    def __init__(self, user_state: UserState):
        ...
        self.user_state_accessor = self._user_state.create_property("WelcomeState")
    ...
    async def on_turn(self, turn_context: TurnContext):
        ...
        # save changes to WelcomeState after each turn
